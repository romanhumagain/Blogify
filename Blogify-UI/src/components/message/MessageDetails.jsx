        ...
        <div className='relative h-screen p-4 bg-gray-200 dark:bg-neutral-800'>
            ...
            <div className='flex-1 overflow-y-auto'>
                <div className='flex justify-end mb-1'>
                    <p className='inline p-2 bg-slate-400 dark:bg-neutral-300 rounded-xl'>Hello</p>
                </div>

                <div className='flex justify-start mb-1'>
                    <p className='inline p-2 bg-gray-300 dark:bg-neutral-500 rounded-xl'>Hey Roman</p>
                </div><div className='flex justify-start mb-1'>
                    <p className='inline p-2 bg-gray-300 dark:bg-neutral-500 rounded-xl'>How Are You</p>
                </div>
