        ...
        <>
            <div className='grid items-center grid-cols-12 p-2 mt-5 rounded-md hover:bg-gray-200 dark:hover:bg-neutral-800'>
                ...
                <div className='col-span-1'>
                    <RxCross1 className='text-xl transition-transform cursor-pointer text-neutral-500 hover:scale-105 hover:text-neutral-700 dark:hover:text-neutral-300' title='Remove' />
                </div>
            </div>
        </>
    )
